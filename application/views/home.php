              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="owl-carousel owl-theme">
                     ...
                     <!--  <div class="header-info items">
                          <h6>We are here to realize your dreams</h6>
                          <h1>We are Aclema</h1>
                          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Esse aspernatur ex quaerat soluta odit earum aut beatae hic maiores aliquid modi illo sequi, adipisci sunt. Perferendis corporis numquam eos nesciunt.</p>
                          <a class="butn" href="#"> <span>Contact Us</span> </a>
                      </div> -->
                  </div>
                </div>
              </div>
...
<!-- =====================================
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <!-- navbar brand -->
            <a cslass="navbar-brand" href="#" >
                <img style="height: 50px; width: 100%;" src="<?= base_url('assets/img/')?>/logoku.png" alt="">
            </a>
            <!-- <div>
              PENERIMAAN PESERTA DIDIK BARU 2022/2023<br>
              SMK PUTRA BANGSA
            </div> -->
       ...
       <div class="r-nav">
        <!-- <span class="search-input">
          <form>
            ...
            <a href="#0" type="submit"><i class="fa fa-arrow-right"></i></a>
          </form>
            
        </span> -->
        <span class="search" style="background-color:green;">
       ...
       <div class="l-nav">
        <span class="to-top">
         <a href="#0" data-scroll-nav="0"><i class="fa fa-angle-up"></i></a>
        </span>
       </div>
    </nav>
    <!-- =====================================
      ...
      <section class="about section-padding" data-scroll-index="1">
        <div class="container">
         ...
         <!--  <div class="section-head text-center">
            <h2 data-text="About"> <span>About Us</span> </h2>
          </div> -->
          <div class="row">
            <!-- about info -->
            <div class="col-lg-6">
    ...
    ==== Start portfolio -->
      <section class="portfolio section-padding" data-scroll-index="2">
        <div class="container-fluid">
          <!-- section-head -->
          <!--   <div class="section-head text-center">
              <h2 data-text="Portfolio"> <span>Our Projects</span> </h2>
            </div> -->
           ...
           <!--  <div class="taps text-center">
                ...
                <span data-filter=".Markting">Markting</span>
            </div> -->
      ...
      <section class="clients section-padding" data-scroll-index="3">
        <div class="container">
          ...
          <!-- <div class="sections-head text-center">
            <h2 data-text="Testimonial"><span>Kata Alumni</span></h2>
          </div> -->
