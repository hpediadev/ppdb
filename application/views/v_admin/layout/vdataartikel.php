    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12"> <div class="alert alert-danger alert-dismissible">
            ...
            <a href="<?= base_url('webadmsekolah/artikel/tambah/')?>"><button class="btn btn-primary btn-sm btn-block"><i class="fa fa-plus"></i> Tambah Artikel</button></a>
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <div>
                    <a onClick="confirm_modal('<?php echo base_url('webadmsekolah/artikel/hapus/'.$row->IDARTIKEL) ?>');" hlref="<?php echo base_url('webadmsekolah/artikel/hapus/'.$row->IDARTIKEL) ?>"><button type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>
                    <a href="<?php echo base_url('webadmsekolah/artikel/edit/'.$row->IDARTIKEL) ?>"><button  type="button" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></button></a>
                    <a href="<?php echo base_url('webadmsekolah/artikel/lihat/'.$row->IDARTIKEL) ?>"><button type="button" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></button></a>
                    </div>
                  </td>
