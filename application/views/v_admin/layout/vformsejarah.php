        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Sejarah</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" enctype="multipart/form-data" action="<?= base_url('webadmsekolah/sejarah/simpan')?>">
              <div class="box-body">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Simmpan</button>
                 <a href="<?= base_url('webadmsekolah/sejarah')?>"><button type="button" class="btn btn-danger"><i class="fa fa-check"></i> Kembali</button></a>
              </div>
            </form>
          </div>
        </div>
