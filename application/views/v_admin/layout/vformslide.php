          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" enctype="multipart/form-data" action="<?= base_url('webadmsekolah/slide/simpanslide')?>">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Simmpan</button>
                 <a href="../../slide"><button type="button" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</button></a>
              </div>
            </form>
          </div>
        </div>
