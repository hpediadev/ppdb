  ...
  <footer class="main-footer">
    ...
    <strong>Powered by <i class="fa fa-love"></i><a href="https://mediadigitalofficial.co">Media Digital</a>
  </footer>
...
<!-- AdminLTE for demo purposes -->
<script src="<?= base_url('assets4/plugins/ckeditor/ckeditor.js')?>"></script>
<!-- page script -->
<script>
  $(function () {
    $("#example1").DataTable();
